...
import { createTrainingCourse } from "@/app/actions/student.actions";
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      ...
      if (result?.success) {
        ...
        router.push("/academic-director/courses");
        router.refresh();
      }
    });
  };
          ...
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="min-w-0 animate-in fade-in slide-in-from-left-3 duration-500">
              ...
              <p className="mt-2 text-sm font-semibold text-slate-400">
                Register an official IMTR programme.
              </p>
            </div>
          </div>
          ...
          <section className="overflow-hidden rounded-[26px] border border-slate-200 bg-slate-100/80 shadow-sm">
            ...
            <div className="grid gap-4 p-5 sm:grid-cols-2 sm:p-6">
              ...
              <div className="space-y-2">
                <label htmlFor="category" className="text-xs font-black text-slate-700">
                  Category
                </label>
              ...
              <div className="space-y-2 sm:col-span-2">
                <label htmlFor="title" className="text-xs font-black text-slate-700">
                  Course title
                </label>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    disabled={isPending}
                    placeholder="Meteorological Middle Training Course"
        ...
        <aside className="xl:sticky xl:top-24 xl:self-start">
          <div className="rounded-[26px] border border-slate-200 bg-slate-100/80 p-5 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              <GuideItem text="Use short codes like MMTC21." />
              <GuideItem text="Pick the correct category." />
              <GuideItem text="Course codes affect admission numbers." />
            </div>
          </div>
        </aside>
      </div>
