  ...
  try {
    ...
    const pdfBuffer = await new Promise<Buffer>((resolve, reject) => {
      try {
        ...
        doc
          ...
          .font("Helvetica")
          .fillColor("#64748b")
          .text("MASTER CLASS TIMETABLE", { align: "center" });
        doc.moveDown(1.5);
        ...
        DAYS.forEach((day) => {
          const dayEntries = entries.filter((e) => String(e.dayOfWeek) === day);
        ...
        for (let i = 0; i < pages; i++) {
          ...
          doc
            ...
            .fillColor("#94a3b8")
            .text(
              `Generated on ${new Date().toLocaleString("en-GB")} | Master Schedule Document.`,
              40,
              780,
              { align: "center" },
            );
    ...
    return new Response(pdfBuffer as unknown as BodyInit, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="master-timetable-${intake.code}.pdf"`,
      },
    });
  } catch (error) {
