...
import { verifyStudentIdentityAndBeginActivation } from "@/app/actions/self-service-student-activation.actions";
...
export function StudentActivationForm() {
  ...
  const handleSubmit = (
    ...
    startTransition(async () => {
      const result =
        await verifyStudentIdentityAndBeginActivation(
          formData,
        );
  ...
  return (
    ...
    >
      ...
      <Field
        ...
        placeholder="IMTR/MMTC21/001/2026"
        autoComplete="off"
        disabled={isPending}
        mono
      />
      ...
      <Field
        id="identityNumber"
        label="ID, passport or birth certificate"
        icon={Fingerprint}
        type={
          showIdentity
            ? "text"
