...
import { StaffActivationForm } from "./staff-activation-form";

export const metadata: Metadata = {
  title:
    "Activate Staff Account | IMTR Academic Portal",
  description:
    "Verify a registered IMTR staff account.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function ActivateStaffAccountPage() {
  return (
            ...
            <section className="bg-slate-100 p-6 text-slate-950 sm:p-9 lg:p-12">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="mt-2 text-sm font-semibold text-slate-500">
                  Use the details recorded during registration.
                </p>
