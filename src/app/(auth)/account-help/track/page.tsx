...
import { TicketAccessForm } from "./ticket-access-form";

export const metadata: Metadata = {
  title:
    "Track Recovery | IMTR Academic Portal",
  description:
    "Open a secure IMTR account-recovery ticket.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function TrackRecoveryPage() {
  return (
          ...
          <div className="grid w-full overflow-hidden rounded-[32px] border border-white/10 bg-slate-900/70 shadow-2xl shadow-black/30 backdrop-blur-xl lg:grid-cols-[0.82fr_1.18fr]">
            <aside className="relative hidden overflow-hidden border-r border-white/10 p-10 lg:flex lg:flex-col">
              ...
              <div className="relative flex min-h-[540px] flex-col">
                ...
                <div className="my-auto animate-in fade-in slide-in-from-left-4 duration-700">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.06] text-sky-300">
            ...
            <section className="bg-slate-100 p-6 text-slate-950 sm:p-9 lg:p-12">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-100/70 px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-sky-800">
                ...
                <p className="mt-2 text-sm font-semibold text-slate-500">
                  Enter the details issued with your recovery request.
                </p>
